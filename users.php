 ...
 include_once("common/left_navi.php");
	if(isset($_GET['id']))
	{
		if ($_GET['stat']==0)
			...
			$stat=0;
		$query = "update tab_user set status=".$stat." where id=".$_GET['id']."";
...
<tr>
	...
	<td><a href="?id=<?php echo $row['id']; ?> &stat=<?php echo $row['status']; ?>"> <?php if($row['status']) echo 'De-active'; else echo 'Active'; ?> </a></td>
</tr>
